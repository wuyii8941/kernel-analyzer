#!/usr/bin/env python
"""Independent audit for the history-realized Qwen repair v0.7."""
...
def main() -> None:
    ...
    if args.result:
        ...
        if path.is_file():
            ...
            audit.add(
                ...
                == "forkcert.qwen3-grpo-grad-branch-repair.v0.7",
                result.get("schema_version"),
            )
            ...
            audit.add(
                "history_input_shape",
                result.get("specialization_history_input_shape") == [4, 168],
            )
            audit.add(
                "prior_invalid_versions_preserved",
                result.get("prior_invalid_versions_preserved") == ["v0.5", "v0.6"],
            )
    ...
    payload = {
        "schema_version": "forkcert.qwen3-grpo-grad-branch-repair-audit.v0.7",
        "mode": mode,
