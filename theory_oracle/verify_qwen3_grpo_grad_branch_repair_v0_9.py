#!/usr/bin/env python
"""Independent audit for the resource-bounded Qwen repair v0.9."""
...
def main() -> None:
    ...
    if args.result:
        ...
        if path.is_file():
            ...
            audit.add(
                ...
                == "forkcert.qwen3-grpo-grad-branch-repair.v0.9",
                result.get("schema_version"),
            )
            audit.add(
                "resource_lifetime_isolated",
                result.get("resource_lifetime_isolated_per_arm") is True,
            )
            audit.add(
    ...
    payload = {
        "schema_version": "forkcert.qwen3-grpo-grad-branch-repair-audit.v0.9",
        "mode": mode,
