...
def main():
    ...
    for size in protocol['sizes']:
        for seed in protocol['seeds']:
            ...
            names=['default_compiled','default_eager','off','on','frozen_compensated','fp32']
            ...
            for step in range(1,protocol['steps']+1):
                ...
                comparisons={}
                for left,right in [('on','frozen_compensated'),('off','default_compiled'),('off','default_eager'),('default_eager','default_compiled'),('on','fp32'),('off','fp32')]:
