        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(85L); x0+=static_cast<long>(1L))
        {
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(14L); x1+=static_cast<long>(1L))
            {
                ...
                for(long x2=static_cast<long>(0L); x2<static_cast<long>(7L); x2+=static_cast<long>(1L))
                {
                    ...
                    auto tmp41 = c10::convert<half>(tmp40);
                    out_ptr0[static_cast<long>(x2 + (7L*x1) + (98L*x0))] = tmp41;
                }
            }
        }
    }
    {
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(8320L); x0+=static_cast<long>(16L))
        {
            auto tmp0 = at::vec::Vectorized<half>::loadu(out_ptr0 + static_cast<long>(x0), 16);
            auto tmp1 = cvt_lowp_fp_to_fp32<half>(tmp0);
            auto tmp2 = tmp1.tan();
            auto tmp3 = cvt_fp32_to_lowp_fp<half>(tmp2);
            tmp3.store(out_ptr1 + static_cast<long>(x0), 16);
        }
        #pragma omp simd simdlen(8) 
        for(long x0=static_cast<long>(8320L); x0<static_cast<long>(8330L); x0+=static_cast<long>(1L))
        {
            auto tmp0 = static_cast<float>(out_ptr0[static_cast<long>(x0)]);
            auto tmp1 = c10::convert<float>(tmp0);
            auto tmp2 = std::tan(tmp1);
            auto tmp3 = c10::convert<half>(tmp2);
...
def call(args):
    ...
    buf1 = empty((17, 5, 14, 7), device='cpu', dtype=torch.float16)
    cpp_fused_cat_maximum_mul_tan_0(c_void_p(arg3_1.data_ptr()), c_void_p(arg2_1.data_ptr()), c_void_p(arg1_1.data_ptr()), c_void_p(arg0_1.data_ptr()), c_void_p(arg4_1.data_ptr()), c_void_p(arg5_1.data_ptr()), c_void_p(buf0.data_ptr()), c_void_p(buf1.data_ptr()))
    del arg0_1
    del arg1_1
    del arg2_1
    del arg3_1
