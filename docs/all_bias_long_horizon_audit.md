...
按当前口径，最终计入 **9 个**：其中直接长程方向案例 **5 个**，反馈维持型案例 **1 个**，直接方向未持续但有长程配对 loss 分叉 **3 个**；未决/不可安全重放共 **4 个**，不作阴性判断。
...
| Mamba-130M | in_proj matrix multiply | local arithmetic/pairing | A4096=1.110，p=0.108 | 配对长程阶段未能安全完成，未决 | 长程未保持 |
