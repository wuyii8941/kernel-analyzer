...
def main():
    ...
    payload = {
        ...
        "interpretation": "This is a positive-control stress bank for the public paper reference, not evidence that a vendor FlashAttention kernel has the same arithmetic.",
    }
    out = Path(args.out)
