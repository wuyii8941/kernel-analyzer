...
class MMRepair:
    def __init__(
        ...
        *,
        ...
        self.target_sha = target_sha or TARGET_SHA
        self.allow_shape_fallback = allow_shape_fallback
        self.restores = []
        self.calls = 0
        self.local = None
    ...
    def __enter__(self) -> "MMRepair":
        ...
        for module in self.modules:
            ...
            def wrapped(*args: Any, _original: Any = original, **kwargs: Any) -> Any:
                ...
                digest_matches = digest == self.target_sha
                shape_fallback = self.allow_shape_fallback and tuple(args[0].shape) == TARGET_LEFT_SHAPE
                if not digest_matches and not shape_fallback:
