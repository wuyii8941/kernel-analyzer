...
def build_progress():
    ...
    complete = not remaining and validation['status'] == 'PASS_FIXED_SUITE_PATH'
    summary={"schema":"training-numerical-v2-progress-audit","status":"INCOMPLETE_FULL_RESEARCH_PLAN",
             "selected_experiment_execution_complete":complete,
             "audit_scope":"SELECTED_RECAPTURE_AND_LANGUAGE_EXPERIMENTS_NOT_ENTIRE_20260905_PLAN",
             "full_plan_unverified_requirements":["systematic family capture coverage", "shared same-data baselines and measurement cost", "diagnosis-guided implementation benefit validation"],
             ...
             "population_guarantee_enabled":False,
             ...
             "optional_population_claim":"Disabled until its statistical conditions and calibration are adequate; not required for fixed-suite claims.",
