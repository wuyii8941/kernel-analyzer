...
def main() -> None:
    parser = argparse.ArgumentParser(description="Create a GPU-visible shell runner for early ForkCert phases.")
    ...
    parser.add_argument("--out", default="run_phase1_gpu.sh")
