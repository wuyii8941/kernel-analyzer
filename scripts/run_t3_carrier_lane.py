#!/usr/bin/env python3
"""Wait for completed T2 cells, then run their exhaustive T3 queues."""
...
def main() -> None:
    ...
    for cell in args.cell:
        ...
        marker = (ROOT / "results/coverage/cases/causal" /
                  f"{model}_seq{int(raw_length)}_r1" / "queue_complete.json")
        while not marker.exists():
            time.sleep(30)
        time.sleep(5)
        subprocess.run([
            str(PYTHON), str(ROOT / "scripts/run_t3_carrier_queue.py"),
